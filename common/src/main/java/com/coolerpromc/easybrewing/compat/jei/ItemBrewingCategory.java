...
public record ItemBrewingCategory(IGuiHelper helper) implements IRecipeCategory<ItemBrewingRecipe> {
    public static final IRecipeType<ItemBrewingRecipe> TYPE = IRecipeType.create(Constants.MODID, "item_brewing", ItemBrewingRecipe.class);
    ...
    public @Nullable IDrawable getIcon() {
        return helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, CommonClass.ITEM_BREWING_STATION.toStack());
    }
    ...
    public void draw(ItemBrewingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
        Identifier ITEM_BREWING_STATION = Constants.id("textures/gui/item_brewing_station.png");
