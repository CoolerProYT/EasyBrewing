...
public class ItemBrewingStationMenu extends AbstractContainerMenu {
    ...
    public float getSpeedMultiplier(){
        return this.blockEntity.data.get(3) / 100f;
    }

    public int getMaxUpgrade(){
        return this.blockEntity.data.get(4);
    }

    public int getAdditionalUpgrade(){
        return this.blockEntity.data.get(5);
    }

    public int getMaxAmountUpgrade(){
        return allowAmountUpgrade() ? this.blockEntity.data.get(6) : 0;
    }

    public boolean allowAmountUpgrade(){
        return this.blockEntity.data.get(7) == 1;
    }
}
