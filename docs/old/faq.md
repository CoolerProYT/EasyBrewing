...
## Can I add brewing recipes with a datapack?

Not before Minecraft 26.3. Brewing recipes come from the game and from mods that register them through their loader. See [Brewing recipes](./guide/brewing-recipes).
...
On Minecraft 1.21.1, yes. See [Cobblemon](./guide/compat#cobblemon).
